...
layout: PostSimple
images: ['static/images/twitter-strategy.jpeg']
---

Let me know if this sounds familiar. You click on a startup's Twitter handle, and you see a series of tweets promoting their blog posts and webinars with 2-3 likes each, despite the startup having 10k followers on Twitter. Unfortunately, this is a very common occurance.

Twitter is currently the go-to place where developers hang out. Because of this, any developer tool startup needs to have a solid Twitter presence to meet customers where they are. And let's face it – most developer tool startups _don't_ do a very good job at Twitter.
